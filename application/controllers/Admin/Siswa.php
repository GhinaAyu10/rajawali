...
class Siswa extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/siswa/index', $datab);
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('admin/siswa/print', $data, 'a4', 'portrait', 'Laporan Daftar Siswa');
    }
    ...
    public function detail($id)
    {
        $datau = $this->user_model->getDataUser($this->session->userdata['username']);
        $where = ['id_siswa' => $id];
        $datab['siswa'] = $this->samsat_model->joinWhere('siswa', 'angkatan', 'angkatan.id_angkatan=siswa.angkatan', $where, $id)->result();
        $datac['prestasi'] = $this->samsat_model->joinWhere('prestasi', 'siswa', 'siswa.id_siswa=prestasi.siswa', $where, $id)->result();
        $datad['hukuman'] = $this->samsat_model->joinWhere('hukuman', 'siswa', 'siswa.id_siswa=hukuman.siswa', $where, $id)->result();
