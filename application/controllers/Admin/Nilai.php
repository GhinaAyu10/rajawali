...
class Nilai extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/nilai/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/nilai/add', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_nilai()
    {
        $data = [
            'siswa'       => $this->input->post('siswa', true),
            'pengantar'   => $this->input->post('pengantar', true),
            'pembpribadi' => $this->input->post('pembpribadi', true),
            'pengetahuan' => $this->input->post('pengetahuan', true),
            'perundangan' => $this->input->post('perundangan', true),
            'kesamaptaan' => $this->input->post('kesamaptaan', true),
        ];
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('admin/nilai/print', $data, 'a4', 'portrait', 'Laporan Daftar Nilai Siswa');
    }
    ...
    public function individu($id)
    {
        ...
        $this->load->library('mypdf');
        $this->mypdf->generate('admin/nilai/individu', $data, 'f4', 'portrait', 'Nilai Individu Siswa');
    }
