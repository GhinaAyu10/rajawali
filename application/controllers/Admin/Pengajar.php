...
class Pengajar extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/pengajar/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/pengajar/add');
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/pengajar/edit', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('admin/pengajar/print', $data, 'a4', 'portrait', 'Laporan Daftar Pengajar');
    }
