...
class Kategori extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/kategori/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/kategori/add', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/kategori/edit', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('admin/kategori/print', $data, 'a4', 'portrait', 'Laporan Daftar Kategori');
    }
