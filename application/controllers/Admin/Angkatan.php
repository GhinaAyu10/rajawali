...
class Angkatan extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/angkatan/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/angkatan/add');
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/angkatan/edit', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('admin/angkatan/print', $data, 'a4', 'portrait', 'Laporan Daftar Angkatan');
    }
