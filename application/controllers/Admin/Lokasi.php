...
class Lokasi extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/lokasi/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/lokasi/add', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebara', $datau);
        $this->load->view('admin/lokasi/edit', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('admin/lokasi/print', $data, 'a4', 'portrait', 'Laporan Daftar Lokasi');
    }
