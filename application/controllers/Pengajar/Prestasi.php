...
class Prestasi extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pengajar/prestasi/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgj', $datau);
        $this->load->view('pengajar/prestasi/add', $datab);
        $this->load->view('templates/footer');
    }
            ...
            if ( ! $this->upload->do_upload('filesertif'))
                {
                    ...
                    $this->load->view('pengajar/prestasi/add', $error);
                } else {
                $data = [
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgj', $datau);
        $this->load->view('pengajar/prestasi/edit', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_prestasi()
    {
        ...
        if ( ! $this->upload->do_upload('filesertif'))
            {
                $error = array('error' => $this->upload->display_errors());
                $this->load->view('pengajar/prestasi/edit', $error);
            } else {
            $data = [
                'siswa'       => $this->input->post('siswa', true),
                'kompetisi'   => $this->input->post('kompetisi', true),
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pengajar/prestasi/print', $data, 'a4', 'portrait', 'Laporan Daftar Prestasi Siswa');
    }
