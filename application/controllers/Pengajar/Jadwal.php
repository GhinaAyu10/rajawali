...
class Jadwal extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pengajar/jadwal/index', $data);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgj', $datau);
        $this->load->view('pengajar/jadwal/add', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgj', $datau);
        $this->load->view('pengajar/jadwal/edit', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pengajar/jadwal/print', $data, 'a4', 'portrait', 'Laporan Jadwal Kelas');
    }
