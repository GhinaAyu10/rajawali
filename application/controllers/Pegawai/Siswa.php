...
class Siswa extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pegawai/siswa/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/siswa/add', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/siswa/edit', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pegawai/siswa/print', $data, 'a4', 'portrait', 'Laporan Daftar Siswa');
    }
