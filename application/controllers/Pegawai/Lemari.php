...
class Lemari extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pegawai/lemari/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/lemari/add', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/lemari/edit', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pegawai/lemari/print', $data, 'a4', 'portrait', 'Laporan Daftar Lemari');
    }
