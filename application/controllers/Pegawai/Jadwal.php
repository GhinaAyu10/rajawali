...
class Jadwal extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pegawai/jadwal/index', $data);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/jadwal/add', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/jadwal/edit', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pegawai/jadwal/print', $data, 'a4', 'portrait', 'Laporan Jadwal Kelas');
    }
