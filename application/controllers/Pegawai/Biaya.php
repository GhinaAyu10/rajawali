...
class Biaya extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pegawai/biaya/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/biaya/add');
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/biaya/edit', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pegawai/biaya/print', $data, 'a4', 'portrait', 'Laporan Daftar Biaya');
    }
