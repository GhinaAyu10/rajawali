...
class Pelajaran extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pegawai/pelajaran/index', $datab);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/pelajaran/add');
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/pelajaran/edit', $datab);
        $this->load->view('templates/footer');
    }
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pegawai/pelajaran/print', $data, 'a4', 'portrait', 'Laporan Daftar Pelajaran');
    }
