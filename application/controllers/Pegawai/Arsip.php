...
class Arsip extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('pegawai/arsip/index', $data);
    ...
    public function add()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/arsip/add', $data);
        $this->load->view('templates/footer');
    }
            ...
            if ( ! $this->upload->do_upload('filearsip'))
                {
                    ...
                    $this->load->view('pegawai/arsip/add', $error);
                } else {
                $data = [
    ...
    public function edit($id)
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/sidebarpgw', $datau);
        $this->load->view('pegawai/arsip/edit', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_arsip()
    {
            ...
            {
                $error = array('error' => $this->upload->display_errors());
                $this->load->view('pegawai/arsip/edit', $error);
            } else {
                $data = [
                    'lokasi'    => $this->input->post('lokasi', true),
                    'lemari'    => $this->input->post('lemari', true),
    ...
    public function print()
    {
        ...
        $this->mypdf->generate('pegawai/arsip/print', $data, 'a4', 'portrait', 'Laporan Arsip Digital');
    }
