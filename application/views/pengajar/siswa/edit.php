<div class="container-fluid">
    ...
    <form method="post" action="<?= base_url('pengajar/siswa/edit_siswa') ?>">
        ...
        <div class="row form-group mb-5">
            <div class="col">
                <label>Jabatan</label>
                <input type="text" name="jabatansis" value="<?= $u->id_siswa ?>" class="form-control">
                <?= form_error('jabatansis', '<p class="text-danger small ml-3">') ?>
            </div>
            <div class="col">
                <label>Perusahaan</label>
                <input type="text" name="perusahaansis" value="<?= $u->id_siswa ?>" class="form-control">
        ...
        <a href="<?= base_url('pengajar/siswa') ?>" style="width: 180px;" class="btn btn-danger">Kembali</a></center>
    </form>
