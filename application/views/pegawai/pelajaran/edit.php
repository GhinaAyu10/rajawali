<div class="container-fluid">
    ...
    <form method="post" action="<?= base_url('pegawai/pelajaran/edit_pelajaran') ?>">
        ...
        <a href="<?= base_url('pegawai/pelajaran') ?>" style="width: 180px;" class="btn btn-danger">Kembali</a></center>
    </form>
