<div class="container-fluid">
    ...
    <div class="row mb-2">
        <div class="col">
            <?= anchor('pegawai/jadwal/add','<button class="btn btn-md btn-primary mb-3"><i class="fas fa-plus mr-1"></i> TAMBAH DATA</button>') ?>
        </div>
        <div class="row">
            <div class="col"><form action="<?= base_url('pegawai/jadwal/print') ?>" method="post">
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        foreach($jadwal as $d) : ?>
            ...
            <tr>
                ...
                <td width="15px"><?= anchor('pegawai/jadwal/edit/'.$d->id_jadwal,'<div class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></div>') ?></td>
                <td width="15px"><?= anchor('pegawai/jadwal/delete/'.$d->id_jadwal,'<div class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?></td>
            </tr>
