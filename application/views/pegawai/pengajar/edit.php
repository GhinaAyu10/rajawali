<div class="container-fluid">
    ...
    <form method="post" action="<?= base_url('pegawai/pengajar/edit_pengajar') ?>">
        ...
        <a href="<?= base_url('pegawai/pengajar') ?>" style="width: 180px;" class="btn btn-danger">Kembali</a></center>
    </form>
