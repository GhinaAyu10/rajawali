                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <div class="alert alert-info" role="alert">
                                            <h1 class="h4 text-gray-900 text-primary">Silahkan Login</h1>
                                        </div>
                                    ...
                                    <form method="post" action="<?= base_url('auth/proses_login') ?>" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" placeholder="Password Anda" name="password">
