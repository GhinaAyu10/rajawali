    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item
            ...
            <div id="collapsePagesDocs" class="collapse 
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?= $this->uri->segment(2) == 'lokasi' ? 'active' : '' ?>" href="<?= base_url('admin/lokasi') ?>">Master Lokasi</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'lemari' ? 'active' : '' ?>" href="<?= base_url('admin/lemari') ?>">Master Lemari</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'kategori' ? 'active' : '' ?>" href="<?= base_url('admin/kategori') ?>">Master Kategori</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'arsip' ? 'active' : '' ?>" href="<?= base_url('admin/arsip') ?>">Arsip Digital</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item
            ...
            <div id="collapsePagesType" class="collapse
                ...
                aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?= $this->uri->segment(2) == 'siswa' ? 'active' : '' ?>" href="<?= base_url('admin/siswa') ?>">Master Siswa</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'nilai' ? 'active' : '' ?>" href="<?= base_url('admin/nilai') ?>">Nilai Siswa</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'prestasi' ? 'active' : '' ?>" href="<?= base_url('admin/prestasi') ?>">Prestasi Siswa</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'hukuman' ? 'active' : '' ?>" href="<?= base_url('admin/hukuman') ?>">Hukuman Siswa</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item
            ...
            <div id="collapsePagesPR" class="collapse
                ...
                aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?= $this->uri->segment(2) == 'angkatan' ? 'active' : '' ?>" href="<?= base_url('admin/angkatan') ?>">Master Angkatan</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'pelajaran' ? 'active' : '' ?>" href="<?= base_url('admin/pelajaran') ?>">Master Pelajaran</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'pengajar' ? 'active' : '' ?>" href="<?= base_url('admin/pengajar') ?>">Master Pengajar</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'jadwal' ? 'active' : '' ?>" href="<?= base_url('admin/jadwal') ?>">Jadwal Kelas</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item
            ...
            <div id="collapsePages" class="collapse
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?= $this->uri->segment(2) == 'biaya' ? 'active' : '' ?>" href="<?= base_url('admin/biaya') ?>">Master Biaya</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'bayar' ? 'active' : '' ?>" href="<?= base_url('admin/bayar') ?>">Pembayaran</a>
                </div>
            </div>
        </li>
