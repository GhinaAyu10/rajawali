...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item
            ...
            <div id="collapsePagesType" class="collapse
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?= $this->uri->segment(2) == 'nilai' ? 'active' : '' ?>" href="<?= base_url('siswa/nilai') ?>">Nilai Siswa</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'prestasi' ? 'active' : '' ?>" href="<?= base_url('siswa/prestasi') ?>">Prestasi Siswa</a>
                    <a class="collapse-item <?= $this->uri->segment(2) == 'hukuman' ? 'active' : '' ?>" href="<?= base_url('siswa/hukuman') ?>">Hukuman Siswa</a>
                </div>
            </div>
        </li>
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item <?= $this->uri->segment(2) == 'bayar' ? 'active' : '' ?>">
